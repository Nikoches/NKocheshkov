...
public class arrays_comperison {
    ...
    public int [] comp(int[] arrayA,int[] arrayB) {
        ...
        if (indexFirst<arrayA.length){System.arraycopy (arrayA,indexFirst, arrayFinished, indexThird,arrayA.length-indexFirst+1);}
        else {System.arraycopy (arrayB,indexSecond,arrayFinished,indexThird,arrayB.length-indexFirst+1);}
